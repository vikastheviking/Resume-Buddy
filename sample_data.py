"""
Sample Resumes and Job Descriptions for 1-Click Live Stage Demos.
"""
...
• Converted a conventional petrol bike into a fully functional Electric Vehicle (EV) using a BLDC motor, lithium battery
pack, and motor controller.
• Studied and applied EV powertrain fundamentals, Battery Management System (BMS) design, and motor performance
optimization.
• Achieved measurable reduction in fuel dependency, carbon emissions, and maintenance cost; demonstrated at
national-level EV competitions.
ACHIEVEMENTS & AWARDS
...
About the Role:
We are seeking a high-performing Senior AI/ML Engineer to lead the architecture, training, and production deployment of our next-generation generative AI and LLM agents. You will bridge the gap between research prototypes and high-throughput production microservices.

Key Responsibilities:
- Design, build, and maintain scalable machine learning pipelines and RAG (Retrieval-Augmented Generation) architectures.
- Deploy, fine-tune, and optimize large language models (LLM) using PyTorch, HuggingFace, and vLLM.
- Containerize and orchestrate distributed training and inference workloads using Docker and Kubernetes on AWS or GCP.
- Establish end-to-end MLOps automation with CI/CD, automated testing, model monitoring (Prometheus, Grafana), and drift detection.
- Partner with cross-functional product and engineering teams to define system architecture, data engineering pipelines with Apache Kafka and PostgreSQL, and deliver high-impact features.

Required Qualifications & Skills:
- 5+ years of experience in production Machine Learning and Software Engineering.
- Strong proficiency in Python, PyTorch, Transformers, LangChain/LlamaIndex, and SQL.
- Hands-on expertise with AWS (SageMaker, EKS, S3, EC2) or GCP.
- Production experience with Docker, Kubernetes, Terraform, and CI/CD pipelines.
- Demonstrated track record of optimizing model inference latency (quantization, TensorRT, vLLM) and scaling services to handle thousands of requests per second (QPS).
- Bachelor's or Master's in Computer Science, Data Science, or related quantitative field.
""",
        "resume": """David Vance
Austin, TX | dvance_dev@email.com | 555-019-2834

Summary:
Software developer with experience in machine learning and data science. Worked on several Python projects and built prediction models for business applications.

Skills:
Python, Scikit-learn, Pandas, NumPy, Machine Learning, Deep Learning, SQL, Flask, Git, Linux

Experience:
Machine Learning Developer | Horizon Analytics | 2021 - Present
- Built machine learning models to predict customer churn.
- Cleaned and prepared data using Pandas and SQL queries.
- Created REST APIs using Flask to serve models to the frontend team.
- Participated in weekly sprint meetings and wrote code documentation.

Data Analyst | NextGen Tech | 2019 - 2021
- Created dashboards and reports for stakeholders.
- Ran statistical analysis on company datasets.
- Worked with relational databases and wrote automated scripts.

Education:
B.S. in Information Technology, Texas State University
"""
    },
    "Senior Full-Stack Engineer (FinTech)": {
        "jd": """Senior Full-Stack Engineer (Distributed Systems)

We are hiring a Senior Full-Stack Engineer to architect resilient financial applications processing millions of daily transactions.

Responsibilities:
- Build high-performance, responsive web interfaces using React, TypeScript, Next.js, and Tailwind CSS.
- Architect scalable backend microservices using Python (FastAPI) or Node.js with PostgreSQL and Redis caching.
- Build event-driven architectures with Kafka or RabbitMQ.
- Deploy and monitor cloud infrastructure on AWS using Docker, Kubernetes, and GitHub Actions CI/CD.
- Implement secure payment gateways, OAuth2 authentication, and adhere to SOC2 compliance.

Must-Have Skills:
React, TypeScript, Next.js, Python, FastAPI, PostgreSQL, Redis, Docker, Kubernetes, AWS, CI/CD, GraphQL, Unit Testing (Jest, PyTest), System Design.
""",
        "resume": """Elena Rostova
elena.rostova@example.com | 555-891-3421 | Chicago, IL

Professional Summary:
Web developer with 4 years of experience building applications with JavaScript and Python. Passionate about frontend design and database management.

Technical Skills:
JavaScript, React, HTML5, CSS3, Python, Django, MySQL, Git, REST APIs

Work History:
Web Developer | Apex Digital | 2021 - Present
- Created website pages for clients using React.
- Wrote backend endpoints using Django and connected them to MySQL.
- Fixed bugs and improved site styling.
- Worked with team members using Git for version control.

Junior Developer | ByteCraft Inc | 2019 - 2021
- Assisted senior engineers with frontend styling and bug tickets.
- Maintained database backups and ran reports.
